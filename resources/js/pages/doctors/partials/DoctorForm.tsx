                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setData('commission_percentage', Number(e.target.value || 0))}
                            placeholder="Ex: 20"
                            className="w-full px-4 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition"
                        />
                        <p className="mt-1 text-xs text-gray-400">Default referral commission earned on test amount.</p>
                        {errors.commission_percentage && <p className="mt-1 text-xs text-red-500">{errors.commission_percentage}</p>}
                    </div>
